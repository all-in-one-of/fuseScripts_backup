...
# # INITIAL SETUP
#===============================================================================
        self.ui.images_tableWidget.setIconSize(QSize(160,160))
        ...
        self.ui.images_tableWidget.verticalHeader().setDefaultSectionSize(THUMBNAIL_SIZE+SPACING)
        self.ui.images_tableWidget.verticalHeader().hide()
        # Set the default row height and hide the header
        self.ui.images_tableWidget.horizontalHeader().setDefaultSectionSize(THUMBNAIL_SIZE+SPACING)
...
#===============================================================================
        ...
        #     panels.registerWidgetAsPanel(, 'Hdr Browser', 'uk.co.thefoundry.PlayblastTool')
# #===============================================================================
# # functions
#===============================================================================
